...
<script type="text/javascript" charset=UTF-8">
    ...
    function getPageInfoRemote() {
        ...
        var ajaxResult = $.ajax({
            "url": "admin/get/admin-hotel.json",
            "type":"post",
    ...
    function fillTableBody(pageInfo) {
        ...
        for(var i = 0; i < pageInfo.list.length; i++) {
            ...
            var starLevelTd = "<td>"+starLevel+"</td>";
            var typeTd = "<td>"+type+"</td>";

            var editBtn = "<a title=\"编辑\"  onclick=\"xadmin.open('编辑界面','admin/get/hotel/"+id+"/update.html',500,300)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe642;</i></a>";

            var removeBtn = "<a title=\"删除\" onclick=\"member_del(this,'"+id+"')\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe640;</i></a>";

            var buttonTd = "<td class=\"td-manage\">"+editBtn+" "+removeBtn+"</td>";

            var tr = "<tr>"+checkboxTd+numberTd+nameTd+priceTd+locationTd+starLevelTd+typeTd+buttonTd+"</tr>";
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('新增酒店','admin/get/hotel/add.html',500,300)"><i class="layui-icon"> </i>新增酒店</button>
                </div>
