...
<script type="text/javascript" charset=UTF-8">
    ...
    function getPageInfoRemote() {
        ...
        var ajaxResult = $.ajax({
            "url": "admin/get/admin-article.json",
            "type":"post",
    ...
    function fillTableBody(pageInfo) {
        ...
        for(var i = 0; i < pageInfo.list.length; i++) {
            ...
            var authorNameTd = "<td>"+authorName+"</td>";
            var readNumTd = "<td>"+readNum+"</td>";
            var comNumTd = "<td>"+comNum+"</td>";
            var likeNumTd = "<td>"+likeNum+"</td>";
            var publishTimeTd = "<td>"+publishTime+"</td>";

            var showBtd = "<a title=\"查看\"  onclick=\"xadmin.open('查看','http://localhost/article.html?articleId="+id+"')\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe63c;</i></a>";

            var editBtn = "<a title=\"编辑\"  onclick=\"xadmin.open('编辑界面','admin/get/article/"+id+"/update.html',500,300)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe642;</i></a>";

            var removeBtn = "<a title=\"删除\" onclick=\"member_del(this,'"+id+"')\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe640;</i></a>";

            var buttonTd = "<td class=\"td-manage\">"+showBtd+" "+editBtn+" "+removeBtn+"</td>";

            var tr = "<tr>"+checkboxTd+numberTd+titleTd+authorNameTd+readNumTd+comNumTd+likeNumTd+publishTimeTd+buttonTd+"</tr>";
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('新增文章','articlePublish.html')"><i class="layui-icon"> </i>新增文章</button>
                </div>
...
<script type="text/javascript">
    ...
    if(msg=='1'){
        ...
        window.location.href="admin-article.html?type="+type;
    }
</script>
</html>
