...
<script type="text/javascript" charset=UTF-8">
    ...
    function getPageInfoRemote() {
        ...
        var ajaxResult = $.ajax({
            "url": "admin/get/admin-photo.json",
            "type":"post",
    ...
    function fillTableBody(pageInfo) {
        ...
        for(var i = 0; i < pageInfo.list.length; i++) {
            ...
            var briefIntroTd = "<td>"+briefIntro+"</td>";
            var imgPathTd = "<td>"+imgPath+"</td>";

            var showBtd = "<a title=\"查看\" onclick=\"xadmin.open('查看','"+imgPath+"',500,500)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe63c;</i></a>"

            var editBtn = "<a title=\"编辑\"  onclick=\"xadmin.open('编辑界面','admin/get/photo/"+id+"/update.html',500,300)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe642;</i></a>";
            ...
            var tr = "<tr>"+checkboxTd+numberTd+titleTd+briefIntroTd+imgPathTd+buttonTd+"</tr>";
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('新增图片','admin/get/photo/add.html?photoType=${requestScope.type}',500,300)"><i class="layui-icon"> </i>新增图片</button>
                </div>
