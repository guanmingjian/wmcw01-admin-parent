...
<script type="text/javascript" charset=UTF-8">
    ...
    function fillTableBody(pageInfo) {
        ...
        for(var i = 0; i < pageInfo.list.length; i++) {
            ...
            var roleDescribe = role.description;
            ...
            var checkboxTd = "<td><input type=\"checkbox\" name=\"name\" value='"+roleId+"' lay-skin=\"primary\"></td>";
            var numberTd = "<td>"+roleId+"</td>";
            var roleNameTd = "<td>"+roleName+"</td>";
            var roleDescribeTd = "<td>"+roleDescribe+"</td>";
            var statusTd = "<td class=‘td-status'><span id='statusSpan"+roleId+"' class='"+statusSpanClass+"'>"+status+"</span></td>";

            var checkBtn = "<a onclick=\"member_stop(this,'"+roleId+"')\" href=\"javascript:;\"  title='"+statusTitle+"'><i class=\"layui-icon\">"+statusLogoCode+"</i></a>";

            var assignBtn = "<a title=\"授权\"  onclick=\"xadmin.open('授权界面','admin/get/auth/"+roleId+"/assign.html',500,400)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe672;</i></a>";

            var editBtn = "<a title=\"编辑\"  onclick=\"xadmin.open('编辑界面','admin/get/role/"+roleId+"/update.html',500,300)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe642;</i></a>";

            var removeBtn = "<a title=\"删除\" onclick=\"member_del(this,'"+roleId+"')\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe640;</i></a>";

            var buttonTd = "<td class=\"td-manage\">"+" "+checkBtn+" "+assignBtn+" "+editBtn+" "+removeBtn+"</td>";

            var tr = "<tr>"+checkboxTd+numberTd+roleNameTd+roleDescribeTd+statusTd+buttonTd+"</tr>";
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('新增角色','admin/get/role/add.html',500,300)"><i class="layui-icon"> </i>新增角色</button>
                </div>
