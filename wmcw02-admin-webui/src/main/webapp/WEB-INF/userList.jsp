...
<script type="text/javascript" charset=UTF-8">
    ...
    function getPageInfoRemote() {
        ...
        var ajaxResult = $.ajax({
            "url": "admin/get/admin-userList.json",
            "type":"post",
    ...
    function fillTableBody(pageInfo) {
        ...
        for(var i = 0; i < pageInfo.list.length; i++) {
            ...
            var registerTime = object.registerTime;
            ...
            var sexTd = "<td>"+sex+"</td>";
            var ageTd = "<td>"+age+"</td>";
            var phoneNumberTd = "<td>"+phoneNumber+"</td>";
            var emailTd = "<td>"+email+"</td>";
            var birthTd = "<td>"+birth+"</td>";
            ...
            var editBtn = "<a title=\"编辑界面\"  onclick=\"xadmin.open('编辑','admin/get/user/"+id+"/update.html',600,350)\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe642;</i></a>";
            ...
            var tr = "<tr>"+checkboxTd+numberTd+nameTd+sexTd+ageTd+phoneNumberTd+emailTd+birthTd+typeTd+registerTimeTd+statusTd+buttonTd+"</tr>";
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('新增用户','admin/get/user/add.html',600,400)"><i class="layui-icon"> </i>新增用户</button>
                </div>
    ...
    function member_stop(obj,id){
        ...
        if($(obj).attr('title')=='停用'){
            ...
            layer.confirm('确认要停用吗？',function(index) {
                ...
                $.ajax({
                    "url":"admin/do/user/" + id + "/0/status.json",
                    "type":"post",
                    "beforeSend":function (request) {
                        request.setRequestHeader(csrfHeader,csrfToken);     // 添加 CSRF Token
                    },
        ...
        if($(obj).attr('title')=='启用'){
            ...
            layer.confirm('确认要启用吗？',function(index) {
                ...
                $.ajax({
                    "url":"admin/do/user/"+id+"/1/status.json",
                    "type":"post",
                    "beforeSend":function (request) {
                        request.setRequestHeader(csrfHeader,csrfToken);     // 添加 CSRF Token
                    },
